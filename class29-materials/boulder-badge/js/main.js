...
let weedlCandies = 7 - 1;
let totalCandies = bulbaCandies + caterCandies + weedlCandies;
...
function charCanFight(tempFah){
    const tempCel = fahtoCel(tempFah);
    if(tempCel > 0){
        console.log('Charmander Can Fight!')
    }else{
        console.log('There\'s no way Charmander is fighting on this one')
    }
}
charCanFight(33);
